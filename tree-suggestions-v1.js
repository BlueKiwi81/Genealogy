...
function personFields(person = {}) {
  return `
    <div class="tree-edit-grid">
      ...
      <label>Surname<input name="surname" value="${esc(person.surname || '')}" /></label>
...
function valuesFromForm(form) {
  ...
  const object = {};
  ['given_names','surname','preferred_name','gender','birth_date','death_date','birth_place','death_place','occupation_summary','narrative_summary'].forEach((key) => {
