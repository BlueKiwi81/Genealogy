const CACHE = 'genealogy-admin-v8';
const SHELL = ['./','./index.html','./admin.css?v=1','./tree-snapshot-v1.css?v=1','./voice-note-v1.css?v=1','../mobile-readability-v1.css?v=1','./admin.js?v=3','./tree-snapshot-v1.js?v=1','./intelligent-review-v1.js?v=3','./resume-refresh-v1.js?v=1','./manifest.webmanifest','./icon.svg'];
