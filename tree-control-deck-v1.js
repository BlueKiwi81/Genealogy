...
function installStyles() {
  ...
  style.textContent = `
    ...
    .tree-explorer-controls{display:grid;gap:10px;margin:0 0 8px;padding:12px;border:1px solid #ded3c7;border-radius:17px;background:linear-gradient(180deg,#fffdf9 0%,#faf6ef 100%);box-shadow:0 5px 18px rgba(69,52,38,.035),inset 0 1px 0 rgba(255,255,255,.9)}
    .tree-explorer-main{display:grid;grid-template-columns:minmax(430px,1.45fr) minmax(360px,1fr);gap:10px}
    ...
    .tree-explorer-options{display:grid;grid-template-columns:minmax(430px,1.45fr) minmax(290px,.9fr) auto;gap:10px;align-items:stretch;padding-top:10px;border-top:1px solid #e6ddd3}
