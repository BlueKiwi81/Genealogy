...
async function loadPeople() {
  const { data, error } = await supabase.from('people').select('id,given_names,surname');
...
if (treeCanvas) {
  // Only watch for replacement of the rendered SVG. Do not observe descendants,
  // because this script itself updates label text inside the SVG.
